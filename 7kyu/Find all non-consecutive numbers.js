...
function allNonConsecutive(arr) {
    ...
    // Will check if the current element is 1 more than the previous element
    // If it is, and object with the current index and element value will get pushed to "result" array
    arr.forEach((e,i) => {
